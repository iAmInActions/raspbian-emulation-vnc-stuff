...
# Tested with latest stretch img (and lite version)
#
# Copyleft 2017 by Ignacio Nunez Hernanz <nacho _a_t_ ownyourbits _d_o_t_ com>
# GPL licensed (see end of file) * Use at your own risk!
#
# Modded to run qemu over VNC by iAmInActions in 2021.
#
# Usage:
#   qemu-pi.sh raspbian-latest.img # or any other armhf linux image
#
# Notes:
...
# do it
qemu-system-arm -vnc :0 -kernel $KERNEL -cpu arm1176 -m 256 -M versatilepb $NET_ARGS \
